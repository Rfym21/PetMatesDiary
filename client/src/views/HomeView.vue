<template>
  ...
  <!-- 轮播图 -->
  <van-swipe :autoplay="3000" lazy-render class="mt-2 mb-2 h-60 overflow-hidden">
    <van-swipe-item v-for="image of images" :key="image">
  ...
  <div class="content pb-20">
    ...
    <div class="cat flex mx-auto w-[calc(100vw-2rem)] justify-between px-1 py-2">
      ...
      <div class="cat__right bg-[#fa7e40] h-36 flex-1">猫类种类大全</div>
    ...
    <!-- 每日小知识 -->
    <div class="trivia">
      <h3 class="relative text-center text-2xl font-bold mb-4 border-solid border-slate-900 border-b-4 pb-4">每天一个小知识</h3>
      <section v-for="(item, i) of trivia" :key="i" class="w-[calc(100vw-2rem)] mx-auto px-3 py-2 mb-2 border-b-2 border-dashed border-slate-700">
